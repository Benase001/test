...
if [[ "$lang_choice" == "2" ]]; then
    ...
    MSG_WALLET="\033[33m請輸入錢包地址（預設: RHae9FyyVQUXh4ix5qLVcvDpHp6v6oyopu）：\033[0m"
    ...
    MSG_WALLET="\033[33m请输入钱包地址（默认: RHae9FyyVQUXh4ix5qLVcvDpHp6v6oyopu）：\033[0m"
    ...
    MSG_WALLET="\033[33mウォレットアドレスを入力してください (デフォルト: RHae9FyyVQUXh4ix5qLVcvDpHp6v6oyopu): \033[0m"
    ...
    MSG_WALLET="\033[33m지갑 주소를 입력하세요 (기본값: RHae9FyyVQUXh4ix5qLVcvDpHp6v6oyopu): \033[0m"
    ...
    MSG_WALLET="\033[33mEnter your wallet address (default: RHae9FyyVQUXh4ix5qLVcvDpHp6v6oyopu): \033[0m"
